...
class DeepSearchAgent:
    ...
    def __init__(self, config: Optional[Settings] = None):
        ...
        logger.info(f"搜索工具集: BochaMultimodalSearch (支持5種多模態搜索工具)")
    ...
    def execute_search_tool(self, tool_name: str, query: str, **kwargs) -> BochaResponse:
        ...
        Args:
            tool_name: 工具名稱，可選值：
                - "comprehensive_search": 全面綜合搜索（默認）
                - "web_search_only": 純網頁搜索
                - "search_for_structured_data": 結構化數據查詢
                - "search_last_24_hours": 24小時內最新信息
                - "search_last_week": 本週信息
            query: 搜索查詢
            **kwargs: 額外參數（如max_results）
        ...
        if tool_name == "comprehensive_search":
            ...
            logger.info(f"  ⚠️  未知的搜索工具: {tool_name}，使用默認綜合搜索")
    ...
    def _initial_search_and_summary(self, paragraph_index: int):
        ...
        search_tool = search_output.get("search_tool", "comprehensive_search")  # 默認工具
    ...
    def _reflection_loop(self, paragraph_index: int):
        ...
        for reflection_i in range(self.config.MAX_REFLECTIONS):
            ...
            search_tool = reflection_output.get("search_tool", "comprehensive_search")  # 默認工具
    ...
    def _generate_final_report(self) -> str:
        ...
        try:
            ...
            logger.info(f"LLM格式化失敗，使用備用方法: {str(e)}")
