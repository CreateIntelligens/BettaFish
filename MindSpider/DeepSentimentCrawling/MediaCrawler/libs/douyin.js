...
function generate_rc4_bb_str(url_search_params, user_agent, window_env_str, suffix = "cus", Arguments = [0, 1, 14]) {
    ...
    /**
     * 進行3次加密處理
     * 1: url_search_params兩次sm3之的結果
     * 2: 對後綴兩次sm3之的結果
     * 3: 對ua處理之後的結果
     */
        // url_search_params兩次sm3之的結果
    ...
    // (url_search_params + "cus") 兩次sm3之的結果
    ...
    // 中間進行了環境檢測
    // 代碼索引:  2496 索引值:  17 （索引64關鍵條件）
    // '1536|747|1536|834|0|30|0|0|1536|834|1536|864|1525|747|24|24|Win32'.charCodeAt()得到65位數組
    /**
